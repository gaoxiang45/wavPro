...
filepath = "/home/gaoxiang/eval/syn"
wav_path="/home/gaoxiang/eval"
# filepath = "C:/Users/Simon.Suthers/OneDrive - City, University of London/Dissertation/TIMIT_WAV"

picturepath = "/home/gaoxiang/eval/"

file1 = wav_path + "/eval_batch_001.wav";
file2 = wav_path + "/eval_batch_002.wav";
...
extrapadding = (ceil(len(mixed_series) / sample_rate1) * sample_rate1) - len(mixed_series)  # 向上取整
